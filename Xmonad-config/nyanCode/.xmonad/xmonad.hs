...
col2 = "#277a6d"
col3 = "#1188aa"
wBar = "dzen2 -p -ta l -e 'button3=' -fn 'Droid Sans Fallback-8:bold' -fg '" ++ col1 ++ "' -bg '" ++ col2 ++ "' -h 24 -w 750"
iBar = "sh /home/diarifa/.xmonad/assets/bin/panel-info.sh"
dir_icon = "^ca(1,xdotool key alt+space)^i(/home/diarifa/.xmonad/assets/xbm/"
dmenu_nyan = "dmenu_run -b -h 24 -l 10 -w 500 -x 433 -y 234 -nb '"++ col2 ++"' -sb '" ++ col3 ++ "'"
